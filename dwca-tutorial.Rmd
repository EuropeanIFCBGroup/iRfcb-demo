...
```{r, eval=TRUE}
install.packages(c("iRfcb", "remotes", "uuid"))
...
class_names <- worms_records %>%
  mutate(class = taxa_names, class_clean = taxa_names_clean)
```
...
dwca_archive$exportAsDwCArchive(file.path("data", "iRfcb-DwC-A.zip"))
```
